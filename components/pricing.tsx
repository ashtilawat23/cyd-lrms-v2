...
export const plans = [
    {
        link: process.env.NODE_ENV === 'development' ? 'https://buy.stripe.com/test_eVa2ap00Qbc7g924gg' : '',
        priceId: process.env.NODE_ENV === 'development' ? 'price_1PUyM3LBx3HXIKc6IhBYNNNE' : '',
        price: 19.99,
        duration: '/month'
    },
    {
        link: process.env.NODE_ENV === 'development' ? 'https://buy.stripe.com/test_fZe5mB3d2a83bSM9AB' : '',
        priceId: process.env.NODE_ENV === 'development' ? 'price_1PUyNaLBx3HXIKc6Gfk8vTFJ' : '',
        price: 197.99,
        duration: '/year'
    }
];
